export default {
  ...
  user: {
    ...
    avatar: '头像',
    uploadAvatar: '更换头像',
    avatarHint: '支持 JPG / PNG / WEBP，大小不超过 5MB',
    avatarUploadSuccess: '头像更新成功',
    avatarUploadFailed: '头像更新失败，请稍后重试',
    avatarTypeError: '仅支持 JPG、PNG、WEBP 格式',
    avatarSizeError: '头像大小不能超过 5MB',
    nickname: '昵称',
    ...
    saveProfileFailed: '个人资料更新失败，请稍后重试',
    createdAt: '创建时间',
    basicInfo: '基础信息',
    account: '账号信息',
    security: '安全设置',
